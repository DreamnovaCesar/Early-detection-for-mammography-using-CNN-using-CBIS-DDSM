...
df = pd.read_csv("D:\DDSM\Calc Mammography\DataCSV\DataFrame_Binary_DDSM_Data_ML_SO.csv")
path = "D:\DDSM\Calc Mammography\DataCSV\DataFrame_Binary_DDSM_Data_ML_SO.csv"
...
AllModelValues(df, column_names, path, DataFrameRAW, MultiSVMConfigModels, DataModelsML_SO, DataCSV, NameRAW, 0)

AllModelValues(df, column_names, path, DataFrameNO, MLPConfigModels, DataModelsML_SO, DataCSV, NameNO, 6)

AllModelValues(df, column_names, path, DataFrameCLAHE, KNNConfigModels, DataModelsML_SO, DataCSV, NameCLAHE, 12)

AllModelValues(df, column_names, path, DataFrameHE, RFConfigModels, DataModelsML_SO, DataCSV, NameHE, 18)

AllModelValues(df, column_names, path, DataFrameUM, DTConfigModels, DataModelsML_SO, DataCSV, NameUM, 24)

AllModelValues(df, column_names, path, DataFrameCS, GBCConfigModels, DataModelsML_SO, DataCSV, NameCS, 30)
