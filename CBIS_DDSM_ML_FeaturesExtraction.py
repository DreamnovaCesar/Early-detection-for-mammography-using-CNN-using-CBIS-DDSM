...
from CBIS_DDSM_ML_Functions import Machine_learning_config

from CBIS_DDSM_7_Extract_Feature import featureExtraction
...
def Testing_ML_Models_Biclass_FOF(Model, Technique, All_images, All_labels):
    ...
    Machine_learning_config(Dataframe_concat, Dataframe_save_mias, Dataframe_save_mias_folder, Column_names, Model, Technique, Technique_name_normal, Labels_biclass, Biclass_Data_CSV, Biclass_Data_Models)
...
def Testing_ML_Models_Multiclass_FOF(Model, Technique, All_images, ALL_labels):
    ...
    Machine_learning_config(Dataframe_concat, Dataframe_save_mias, Dataframe_save_mias_folder, Column_names, Model, Technique, Technique_name_normal, Labels_triclass, Multiclass_Data_CSV, Multiclass_Data_Models)
