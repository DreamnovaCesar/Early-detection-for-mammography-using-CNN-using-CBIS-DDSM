...
from CBIS_DDSM_8_CNN_Architectures import configuration_models_folder
...
def Testing_CNN_Models_Biclass_From_Folder(Models, Folder, Technique):
    ...
    Info_dataframe = configuration_models_folder(train_generator, valid_generator, test_generator, Dataframe_save_mias, Dataframe_save_mias_folder, Models, Technique, Labels_biclass, Column_names, X_size, Y_size, Epochs, Biclass_Data_CSV, Biclass_Data_Models, Biclass_Data_Models_Esp)
...
def Testing_CNN_Models_Multiclass_From_Folder(Models, Folder, Technique):
    ...
    Info_dataframe = configuration_models_folder(train_generator, valid_generator, test_generator, Dataframe_save_mias, Dataframe_save_mias_folder, Models, Technique, Labels_triclass, Column_names, X_size, Y_size, Epochs, Multiclass_Data_CSV, Multiclass_Data_Models, Multiclass_Data_Models_Esp)
